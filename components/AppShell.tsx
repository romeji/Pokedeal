...
export function AppShell({ children }:{ children:React.ReactNode }) {
  return <div className="min-h-screen min-w-0 overflow-x-hidden md:grid md:grid-cols-[240px_minmax(0,1fr)]">
    <header className="mobile-header md:hidden"><Link href="/dashboard" className="font-display text-lg font-bold"><span className="text-cyan-300">POKÉ</span>DEAL</Link><AccountControl compact /></header>
